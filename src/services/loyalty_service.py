...
class LoyaltySystem:
    ...
    TIERS = [
        ...
        LoyaltyTier(
            "بلاتيني",
            5000,
            ["خصم 20%", "شحن مجاني", "عروض حصرية", "أولوية الدعم"],
            20.0,
        ),
    ]
    ...
    def earn_points(self, customer_id: int, purchase_amount: float, order_id: Optional[int] = None) -> Dict:
        """
        ...
        """,
            (
                ...
                points,
                order_id,
                f"كسب {points} نقطة من شراء بقيمة {purchase_amount}",
            ),
        )
    ...
    def redeem_points(self, customer_id: int, points: int, order_id: Optional[int] = None) -> Dict:
        """
        ...
        """,
            (
                ...
                -points,
                order_id,
                f"استرداد {points} نقطة مقابل خصم {discount_amount}",
            ),
        )
    ...
    def get_transactions(self, customer_id: int, limit: int = 20) -> List[Dict]:
    ...
    def _update_tier(self, customer_id: int) -> str:
        ...
        result = self.db.execute_query(  # noqa: F841
            """
            UPDATE loyalty_balance
            SET tier = ?,
                updated_at = CURRENT_TIMESTAMP
