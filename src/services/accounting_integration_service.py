...
class AccountingIntegrationService:
    ...
    def sync_purchase(
        self, integration_id: int, purchase_id: int
    ...
    def sync_payment(
        self, integration_id: int, payment_id: int
    ) -> Tuple[bool, Optional[str], Optional[Dict[str, Any]]]:
        """
        مزامنة دفعة
    ...
    def _sync_quickbooks_sale(
        self, integration: Dict[str, Any], sale_data: Dict[str, Any]
    ) -> Tuple[bool, Optional[str], Optional[Dict[str, Any]]]:
        ...
        try:
            ...
            api_url = integration.get("api_url", "https://sandbox-quickbooks.api.intuit.com")  # noqa: F841
            ...
            self._save_sync(
                ...
                provider_response=json.dumps(
                    {"simulated": True, "invoice_data": invoice_data},
                    ensure_ascii=False,
                ),
            )
    ...
    def _sync_xero_sale(
        ...
        try:
            ...
            api_key = integration.get("api_key")
            api_url = integration.get("api_url", "https://api.xero.com")  # noqa: F841
            ...
            invoice_data = {
                "Type": "ACCREC",
                "Contact": {"ContactID": str(sale_data.get("customer_id", ""))},
    ...
    def _sync_quickbooks_purchase(
        self, integration: Dict[str, Any], purchase_data: Dict[str, Any]
    ) -> Tuple[bool, Optional[str], Optional[Dict[str, Any]]]:
