...
class SSOService:
    ...
    def initiate_oauth2_login(self, provider_id: int, redirect_uri: str) -> Dict[str, Any]:
        ...
        try:
            ...
            authorization_url = f"{auth_url}?client_id={client_id}&redirect_uri={redirect_uri}&response_type=code&scope={scope}&state={state}"  # noqa: E501
    ...
    def handle_oauth2_callback(self, provider_id: int, code: str, state: str) -> Dict[str, Any]:
        ...
        try:
            ...
            json.loads(provider.config) if provider.config else {}
