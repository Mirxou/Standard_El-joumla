...
from src.services.report_exporter import ExportFormat, ReportExporter
...
class ScheduledReportsService:
    ...
    def create_scheduled_report(self, report: ScheduledReport) -> Optional[int]:
        ...
        try:
            ...
            # حساب next_run_at
            next_run = self._calculate_next_run(report.frequency, report.schedule_time, report.schedule_day)
    ...
    def _calculate_next_run(
        self, frequency: str, schedule_time: str, schedule_day: Optional[int]
    ) -> Optional[datetime]:
