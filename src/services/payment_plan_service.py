...
class PaymentPlanService:
    ...
    def create_payment_plan(self, plan: PaymentPlan) -> int:
        ...
        params = (
            ...
            float(plan.total_paid),
            float(plan.total_remaining),
            float(plan.total_late_fees),
            plan.notes,
    ...
    def _row_to_dict(self, row) -> Dict[str, Any]:
        ...
        cursor = getattr(self.db, "connection", getattr(self.db, "conn", None)).cursor()
