...
from src.core.intrusion_detection import IntrusionDetectionSystem, ThreatLevel
from src.core.security_monitor import SecurityEventType, SecurityMonitor
    ...
    def generate_login_activity_report(
        ...
        try:
            ...
            report_data = {
                ...
                "login_success_rate": (
                    (len(login_events) / (len(login_events) + len(failed_login_events)) * 100)
                    if (login_events or failed_login_events)
                    else 0
                ),
            }
