...
class SmartAssistantService:
    ...
    def __init__(self, logger=None):
        ...
        self.intents = {
            'SHOW_SALES': [
                r'مبيعات', r'sales', r'sold', r'بعنا', r'income', r'revenue', r'دخل'
            ],
            'CHECK_STOCK': [
                r'stock', r'inventory', r'qty', r'quantity', r'مخزون', r'كمية', r'باقي', r'توفر'
            ],
            'ADD_PRODUCT': [
                r'add product', r'new product', r'create product', r'منتج جديد', r'إضافة منتج'
            ],
            'NAVIGATE': [
                r'go to', r'open', r'show', r'افتح', r'إذهب', r'عرض'
            ],
            'AGENTIC_FIX': [
                r'fix', r'reorder', r'order', r'draft', r'طلب', r'إعادة طلب', r'شراء'
            ],
            'GREETING': [
                r'hello', r'hi', r'salam', r'مرحبا', r'اهلين', r'السلام'
            ]
        }
