        ...
        quick_filters = {
            "products": [
                ...
                },
                {
                    ...
                    "criteria": json.dumps({"field": "current_stock", "operator": "=", "value": 0}),
                },
                {
                    "name": "منتجات عالية السعر (>1000 دج)",
                    "criteria": json.dumps({"field": "price", "operator": ">", "value": 1000}),
                },
            ],
            "customers": [
                {
                    "name": "عملاء لديهم أرصدة مستحقة",
                    "criteria": json.dumps({"field": "current_balance", "operator": ">", "value": 0}),
                },
                {
                    "name": "عملاء VIP (حد ائتماني >50,000)",
                    "criteria": json.dumps({"field": "credit_limit", "operator": ">", "value": 50000}),
                },
            ],
            "sales": [
                {
                    "name": "مبيعات اليوم",
                    "criteria": json.dumps({"field": "sale_date", "operator": "=", "value": "TODAY"}),
                },
                {
                    "name": "مبيعات هذا الشهر",
                    "criteria": json.dumps({"field": "sale_date", "operator": "MONTH", "value": "CURRENT"}),
                },
                {
                    "name": "مبيعات معلقة",
                    "criteria": json.dumps({"field": "status", "operator": "=", "value": "pending"}),
                },
            ],
        }
