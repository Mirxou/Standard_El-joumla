...
class InvoicePrintService:
    ...
    def __init__(self, template_dir: Optional[str] = None):
        ...
        try:
            ...
            logger.error(f"❌ فشل تحميل قوالب الطباعة: {e}")
            self.env = None
    ...
    def generate_invoice_html(
        ...
        try:
            ...
            try:
                ...
                return False, f"القالب '{template_name}' غير موجود في {self.template_dir}", None
    ...
    def _generate_qr_code(self, invoice_id: str, data: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            qr_content = f"INVOICE:{invoice_id}|TOTAL:{data.get('total', data.get('grand_total', 0))}|DATE:{data.get('date', '')}"
