        ...
        try:
            ...
            with self.db.get_connection() as conn:
                ...
                for row in cursor.fetchall():
                    ...
                    last_purchase_days = (
                        (datetime.now() - customer["last_purchase"]).days if customer["last_purchase"] else 999
                    )
        ...
        try:
            ...
            with self.db.get_connection() as conn:
                ...
                if len(cash_flow_data) >= 7:
                    ...
                    previous_avg = (
                        np.mean([item["cash_flow"] for item in cash_flow_data[:-7]])
                        if len(cash_flow_data) > 7
                        else recent_avg
                    )
        ...
        try:
            ...
            return PredictiveInsight(
                ...
                risk_assessment={
                    ...
                    "mitigation": [
                        "diversify_product_lines",
                        "monitor_market_indicators",
                    ],
                },
                generated_at=datetime.now(),
            )
            ...
            with self.db.get_connection() as conn:
                ...
                if top_products:
                    ...
                    return PredictiveInsight(
                        ...
                        confidence_interval=(
                            total_daily_demand * 0.7,
                            total_daily_demand * 1.3,
                        ),
