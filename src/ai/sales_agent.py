...
class SalesAgent(BaseAgent):
    ...
    def _analyze_sales(self, task: AgentTask) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis": "تم تحليل المبيعات بنجاح",
            "message": "تم تحليل المبيعات بنجاح",
            "insights": [
            ...
            "summary": {
                ...
                "active_customers": len(
                    [
                        c
                        for c in customers
                        if (datetime.now().date() - datetime.fromisoformat(c["last_purchase"]).date()).days <= 30
                    ]
                ),
    ...
    def _predict_sales(self, task: AgentTask) -> Dict[str, Any]:
        ...
        predictions = {
            ...
            "next_month": 58000.0,
            "confidence": 0.85,
            "factors": ["اتجاه المبيعات الحالي", "الموسم الحالي", "أداء المنتجات"],
            "recommendations": [
