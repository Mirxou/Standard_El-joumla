...
class DeltaSyncService:
    ...
    def get_changed_items(self, table_name: str, since: Optional[datetime] = None, 
    ...
    def get_all_changed_items(self, since: Optional[datetime] = None, 
                              limit_per_table: int = 100) -> Dict[str, List[Dict[str, Any]]]:
        """
