...
def upgrade(db: LocalDatabaseManager):
    """
    تطبيق Migration
...
def downgrade(db: LocalDatabaseManager):
    """
    ...
    tables = [
        'sync_queue', 'sync_status', 'products', 'customers', 'sales',
        'sale_items', 'batches', 'categories', 'suppliers'
    ]
    for table in tables:
        try:
