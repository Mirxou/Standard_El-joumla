...
class PermissionManager:
        ...
        try:
            ...
            if "role_id" not in columns:
                ...
                try:
                    ...
                    logging.getLogger(__name__).warning("Ignored exception in permission_manager.py")
    ...
    def _initialize_default_roles(self):
        ...
        for role_data in default_roles:
            try:
                ...
                try:
                    existing = self.db.fetch_one("SELECT role_id FROM roles WHERE name = ?", (role_data["name"],))
                except Exception:
                    # إذا فشل fetch_one، استخدم execute_query
                    result = self.db.execute_query("SELECT role_id FROM roles WHERE name = ?", (role_data["name"],))
    ...
    def create_role(self, name: str, description: str = "", permissions: Optional[Set[str]] = None) -> Optional[int]:
        """
        إنشاء دور جديد
        ...
        try:
            ...
            logger.log(logging.ERROR, f"Failed to create role: {str(e)}")
            return None
    ...
    def get_role(self, role_id: int) -> Optional[Role]:
        ...
        Returns:
            كائن الدور أو None
        """
        row = self.db.fetch_one("SELECT * FROM roles WHERE role_id = ?", (role_id,))
    ...
    def get_role_by_name(self, name: str) -> Optional[Role]:
        ...
        row = self.db.fetch_one("SELECT * FROM roles WHERE name = ?", (name,))
    ...
    def update_role_permissions(self, role_id: int, permissions: Set[str]) -> bool:
        ...
        try:
            ...
            logger.log(logging.ERROR, f"Failed to update role permissions: {str(e)}")
            return False
    ...
    def check_permission(self, user_id: int, permission: str, company_id: Optional[int] = None) -> bool:
        ...
        try:
            ...
            logger.log(logging.ERROR, f"Permission check failed: {str(e)}")
            return False
    ...
    def get_user_permissions(self, user_id: int, company_id: Optional[int] = None) -> Set[str]:
        ...
        try:
            ...
            logger.log(logging.ERROR, f"Failed to get user permissions: {str(e)}")
            return set()
