...
from PySide6.QtWidgets import (
    QWidget, QTabWidget, QTableWidget, QTableView,
    QComboBox, QCheckBox, QLineEdit, QDateEdit, QSpinBox,
...
class WindowStateManager(QObject):
    ...
    def save_filter_state(self, window_key: str, filter_widgets: Dict[str, Any], filter_key: str = "main_filters"):
        """
        حفظ حالة الفلاتر
    ...
    def restore_filter_state(self, window_key: str, filter_widgets: Dict[str, Any], filter_key: str = "main_filters") -> bool:
        """
    ...
    def save_table_state(self, window_key: str, table: QTableWidget | QTableView, table_key: str = "main_table"):
        """
        حفظ حالة الجدول
    ...
    def restore_table_state(self, window_key: str, table: QTableWidget | QTableView, table_key: str = "main_table") -> bool:
        """
        استعادة حالة الجدول
