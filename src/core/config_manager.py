...
class ConfigManager:
    ...
    def get_templates_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'qr_code': templates_config.get('qr_code', {
                'enabled': True,
                'size': 100,
                'error_correction': 'M',
                'include_data': True
            }),
            'barcode': templates_config.get('barcode', {
                'enabled': True,
                'format': 'code128',
                'height': 50,
                'width': 2
            }),
            'images': templates_config.get('images', {
                'max_size_mb': 5,
                'allowed_formats': ['jpg', 'jpeg', 'png', 'gif'],
                'auto_resize': True,
                'thumbnail_size': 150,
            ...
            'signatures': templates_config.get('signatures', {
                'enabled': False,
                'require_signature': False,
                'signature_position': 'bottom'
            })
    ...
    def validate_config(self) -> List[str]:
        ...
        for template_key in ['default_invoice_template', 'default_receipt_template', 'default_quote_template']:
