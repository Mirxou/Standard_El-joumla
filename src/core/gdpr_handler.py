...
class GDPRHandler:
    ...
    def request_data_access(self, customer_id: int, requested_by: Optional[int] = None) -> Optional[int]:
        ...
        try:
            ...
            result = self.db_manager.execute_query(query, (
                "ACCESS", customer_id, "PENDING", requested_by, company_id
            ))
    ...
    def request_data_rectification(
        ...
        try:
            ...
            result = self.db_manager.execute_query(query, (
                "RECTIFICATION", customer_id, "PENDING", request_data_json, requested_by, company_id
            ))
    ...
    def request_data_erasure(
        ...
        try:
            ...
            result = self.db_manager.execute_query(query, (
                "ERASURE", customer_id, "PENDING", request_data_json, requested_by, company_id
            ))
        ...
        try:
            if anonymize:
                ...
                self.db_manager.execute_query(update_query, (
                    anonymized_name, anonymized_email, customer_id
                ))
    ...
    def request_data_portability(
        ...
        try:
            ...
            result = self.db_manager.execute_query(query, (
                "PORTABILITY", customer_id, "PENDING", request_data_json, requested_by, company_id
            ))
    ...
    def update_request_status(
        ...
        try:
            ...
            result = self.db_manager.execute_query(query, (
                status, response_json, completed_at, request_id
            ))
