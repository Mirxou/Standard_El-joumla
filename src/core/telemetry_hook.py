...
class WindowTelemetry(QObject):
        ...
        try:
            data = {
                ...
                'statistics': {
                    ...
                    'avg_open_time': {
                        k: self._total_open_time[k] / self._open_counts[k]
                        if self._open_counts[k] > 0 else 0
    ...
    def on_window_opening(self, window_key: str, instance: Optional[QWidget] = None, kwargs: Dict[str, Any] = None):
    ...
    def get_all_metrics(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            window_key: self.get_metrics(window_key)
            for window_key in self._open_counts.keys()
        }
