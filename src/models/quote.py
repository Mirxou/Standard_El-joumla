...
class Quote:
        ...
        for field_name in date_fields:
            ...
            if isinstance(value, str) and value:
                try:
                    ...
                    logging.getLogger(__name__).warning("Ignored exception in quote.py")
    ...
    def can_be_converted(self) -> bool:
        ...
        return (
            self.status in [QuoteStatus.ACCEPTED, QuoteStatus.SENT]
            and self.is_valid
            and not self.converted_to_sale_id
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Quote":
        ...
        # تحويل البنود
        quote.items = [QuoteItem.from_dict(item) if isinstance(item, dict) else item for item in items_data]
        return quote
