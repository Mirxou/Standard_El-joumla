    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Permission":
        return cls(
            ...
            created_at=(
                ...
                else (datetime.fromisoformat(data["created_at"]) if data.get("created_at") else None)
            ),
        )
...
class Role:
    ...
    def can_perform(self, resource: ResourceType, action: PermissionAction) -> bool:
        ...
        return any(p.resource_type == resource and p.action == action for p in self.permissions)
