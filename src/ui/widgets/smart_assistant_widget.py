...
class ChatBubble(QFrame):
    def __init__(self, text, is_user=False, parent=None):
        ...
        label.setStyleSheet("border: none; background: transparent; color: white;" if is_user else "border: none; background: transparent; color: #333;")
...
class SmartAssistantWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Add greeting
        QTimer.singleShot(500, lambda: self.add_message("مرحباً! أنا مساعدك الذكي. كيف يمكنني خدمتك؟", False))
