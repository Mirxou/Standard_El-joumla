...
class BlockingOverlay(QWidget):
    ...
    def __init__(self, parent: QWidget, message: str = "جاري المعالجة...", 
                 show_cancel: bool = False, show_skip: bool = False):
    ...
    def paintEvent(self, event):
        """رسم Overlay مع تأثير blur"""
        painter = QPainter(self)
        painter.setRenderHint(QPainter.Antialiasing)
        
        # خلفية شفافة مع blur effect
        brush = QBrush(QColor(0, 0, 0, 180))  # أسود شفاف
