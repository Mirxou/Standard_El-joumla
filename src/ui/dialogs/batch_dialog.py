...
class BatchDialog(BaseDialog):
    ...
    def save_batch(self):
        ...
        try:
            ...
            serials = self.serial_numbers_text.toPlainText().strip()
            ...
            batch_data = {
                ...
                "current_quantity": Decimal(str(self.remaining_qty_spin.value())),
            ...
            if self.batch:
                ...
                self.db_manager.execute_query(
                    ...
                    (
                        ...
                        batch_data["status"],
                        ",".join(batch_data["serial_numbers"]),
                        batch_data["notes"],
                        batch_id,
                    ),
                )
                ...
                self.service.create_batch(batch)
