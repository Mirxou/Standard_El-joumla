...
class AdjustStockDialog(QDialog):
    ...
    def _handle_save(self):
        ...
        if not product:
            QMessageBox.warning(self, self.i18n.get_message("warning"), self.i18n.get_message("select_product"))
            return
        ...
        try:
            ...
            if success:
                ...
                QMessageBox.information(self, self.i18n.get_message("success"), self.i18n.get_message("stock_adjusted_success"))
                self.stock_adjusted.emit()
                self.accept()
            else:
                QMessageBox.warning(self, self.i18n.get_message("warning"), self.i18n.get_message("stock_adjust_failed"))
        except Exception as e:
            QMessageBox.critical(self, self.i18n.get_message("error"), f"{self.i18n.get_message('stock_adjust_error')}:\n{str(e)}")
