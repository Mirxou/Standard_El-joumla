...
class RolesManagerWidget(QWidget):
        ...
        try:
            ...
            for i, r in enumerate(roles):
                ...
                perms = (
                    ...
                    if isinstance(r.get("permissions"), list)
                    else str(r.get("permissions", ""))
                )
    ...
    def _get_users_count_for_role(self, role_id) -> int:
        ...
        try:
            result = self.db.execute_query("SELECT COUNT(*) as count FROM user_roles WHERE role_id = ?", (role_id,))
    ...
    def bulk_assign_dialog(self):
        ...
        try:
            ...
            logging.getLogger(__name__).warning("Ignored exception in roles_manager.py")
