...
class IntegrationManagementWindow(QMainWindow):
    ...
    def test_integration(self):
        ...
        QMessageBox.information(
            ...
            f"ملاحظة: اختبار التكامل الفعلي يتطلب تفعيل API Keys"
        )
...
class IntegrationDialog(QDialog):
    ...
    def __init__(self, parent, integration_service: IntegrationService, integration: Optional[Integration] = None):
        super().__init__(parent)
