...
class AIPredictionsWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.sales_table.setHorizontalHeaderLabels(["التاريخ", "المبلغ المتوقع", "الثقة", "الحالة"])
        ...
        self.demand_table.setHorizontalHeaderLabels(["التاريخ", "الكمية المتوقعة", "الحالة"])
        ...
        self.churn_table.setHorizontalHeaderLabels(["العميل", "احتمالية الفقدان", "مستوى الخطر", "التنبؤ", "الحالة"])
        ...
        self.recommendations_table.setHorizontalHeaderLabels(["المنتج", "السعر", "المبيعات", "الحالة"])
    ...
    def forecast_sales(self):
        ...
        self.prediction_worker = PredictionWorker(self.ai_service, "sales", days_ahead=days, product_id=product_id)
    ...
    def forecast_demand(self):
        ...
        self.prediction_worker = PredictionWorker(self.ai_service, "demand", product_id=product_id, days_ahead=days)
    ...
    def predict_churn(self):
        ...
        self.prediction_worker = PredictionWorker(self.ai_service, "churn")
    ...
    def get_recommendations(self):
        ...
        self.prediction_worker = PredictionWorker(self.ai_service, "recommendations", **kwargs)
