...
from PySide6.QtWidgets import (
    ...
    QStatusBar, QTimeEdit, QSpinBox, QAbstractItemView, QDialog,
    QDialogButtonBox, QLineEdit, QCheckBox, QTextEdit
)
...
from src.services.scheduled_reports_service import (
    ScheduledReportsService, ScheduledReport, ScheduleFrequency
)
...
class ScheduledReportDialog(QDialog):
    ...
    def __init__(self, parent, scheduled_reports_service: ScheduledReportsService, report: Optional[ScheduledReport] = None):
...
class ScheduledReportsWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.reports_table.setHorizontalHeaderLabels([
            "ID", "الاسم", "النوع", "التكرار", "الوقت", "نشط", "آخر تشغيل", "التشغيل القادم"
        ])
