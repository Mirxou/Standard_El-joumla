...
class QuotesWindow(QMainWindow):
    ...
    def _create_quotes_list(self):
        ...
        self.quotes_table.setHorizontalHeaderLabels(["الرقم", "العميل", "التاريخ", "الصلاحية", "المبلغ", "الحالة"])
    ...
    def _create_quote_details(self):
        ...
        self.items_table.setHorizontalHeaderLabels(["المنتج", "الكمية", "السعر", "الخصم", "الضريبة", "الإجمالي"])
    ...
    def _convert_to_invoice(self):
        ...
        QMessageBox.information(self, "قريباً", "سيتم تفعيل ميزة تحويل عرض السعر لفاتورة بيع قريباً")
    ...
    def send_quote(self, quote_id, customer_email=None):
        """إرسال عرض"""
        return True
