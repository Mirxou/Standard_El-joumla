...
from PySide6.QtWidgets import (
    ...
    QStatusBar, QDateEdit, QAbstractItemView, QFileDialog
)
...
from src.ui.widgets.advanced_charts import LineChartWidget, BarChartWidget, PieChartWidget
...
class AnalyticsDashboardWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.sales_customer_table.setHorizontalHeaderLabels([
            "العميل", "عدد المبيعات", "المجموع", "المتوسط"
        ])
        ...
        self.stock_alerts_table.setHorizontalHeaderLabels([
    ...
    def load_sales_analytics(self, start_date: datetime, end_date: datetime):
        ...
        # Sales by Customer
        customer_result = self.analytics_service.get_sales_by_customer(limit=10, start_date=start_date, end_date=end_date)
    ...
    def load_inventory_analytics(self):
        ...
        if turnover_result.get("success"):
            ...
            if data:
                ...
                turnover_data = {
                    "معدل الدوران": [item['turnover_rate'] for item in data]
                }
    ...
    def load_financial_analytics(self, start_date: datetime, end_date: datetime):
        ...
        if profit_result.get("success"):
            ...
            if data:
                categories = [item['product_name'] for item in data]
                margin_data = {
                    "هامش الربح %": [item['margin_percent'] for item in data]
                }
    ...
    def export_data(self):
        ...
        export_data = {
            ...
            "sales_by_customer": self.analytics_service.get_sales_by_customer(limit=100, start_date=start_date, end_date=end_date),
        ...
        if file_path.endswith('.json'):
            ...
            if export_data.get("sales_by_customer", {}).get("data"):
                success = self.analytics_service.export_to_csv(
                    export_data["sales_by_customer"]["data"],
                    file_path
                )
            else:
                success = False
