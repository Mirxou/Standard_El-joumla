...
class WorkflowStepDialog(QDialog):
    ...
    def __init__(self, step: Optional[WorkflowStep] = None,
                 workflow_id: int = 0,
                 workflow_service: WorkflowService = None,
                 parent=None):
        super().__init__(parent)
...
class WorkflowDesignerWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.steps_table.setHorizontalHeaderLabels([
            "الترتيب", "الاسم", "النوع", "الموافق", "المهلة", "إلزامية"
        ])
    ...
    def load_workflows(self):
        ...
        try:
            ...
            entity_types = ["purchase_order", "sale", "payment", "invoice", "quote", "return_invoice"]
            all_workflows = []
            
            for entity_type in entity_types:
                workflows = self.workflow_service.get_workflows_by_entity_type(
    ...
    def load_workflow_steps(self, workflow_id: int):
        ...
        try:
            ...
            self.workflow_info_label.setText(
                f"سير العمل: {workflow.name} ({workflow.entity_type})"
            )
