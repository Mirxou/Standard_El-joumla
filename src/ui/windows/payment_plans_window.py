...
class PaymentPlansWindow(QMainWindow):
    ...
    def __init__(self, db_manager: DatabaseManager, parent=None):
        ...
        self.setWindowTitle("إدارة خطط الدفع")
    ...
    def load_payment_plans(self):
        ...
        try:
            ...
            plans = self.service.get_all_payment_plans(
                customer_id=None, status=status, from_date=from_date, to_date=to_date
            )
    ...
    def load_upcoming_installments(self):
        ...
        try:
            ...
            pass  # Error loading upcoming installments
        ...
        try:
            ...
            for row, inst_data in enumerate(overdue):
                ...
                self.overdue_table.setItem(
                    row,
                    2,
                    QTableWidgetItem(str(inst_data.get("installment_number", ""))),
                )
                ...
                self.overdue_table.setItem(
                    row,
                    5,
                    QTableWidgetItem(f"{inst_data.get('remaining_amount', 0):,.2f}"),
                )
            ...
            pass  # Error loading overdue installments
    ...
    def update_statistics(self):
        ...
        try:
            ...
            pass  # Error updating statistics
    ...
    def record_payment(self, installment_id=None, amount=None):
        """تسجيل دفعة"""
