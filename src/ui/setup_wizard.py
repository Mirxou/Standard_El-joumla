...
class InitialDataPage(QWizardPage):
    ...
    def __init__(self):
        ...
        intro_label = QLabel("سننشئ بعض البيانات الأولية لمساعدتك في البدء. " "يمكنك تعديل أو حذف هذه البيانات لاحقاً.")
        ...
        note_label = QLabel("\nملاحظة: البيانات التجريبية تشمل منتجات وعملاء " "وموردين وفواتير للتدريب فقط.")
        note_label.setStyleSheet("color: #666; font-size: 10px;")
        note_label.setWordWrap(True)
...
class SetupWizard(QWizard):
    ...
    def accept(self):
        ...
        try:
            ...
            QMessageBox.information(self, "نجح", "تم إعداد النظام بنجاح!\nسيتم إعادة تشغيل التطبيق.")

            super().accept()

        except Exception as e:
            QMessageBox.critical(self, "خطأ", f"فشل تطبيق الإعدادات:\n{str(e)}")
