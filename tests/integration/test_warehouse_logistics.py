...
from src.services.logistics_integration_service import (
    Carrier,
...
class TestMultiWarehouseManagementService(unittest.TestCase):
    ...
    @patch(
        "services.multi_warehouse_management_service.MultiWarehouseManagementService._calculate_optimal_distribution"
    )
    @patch("services.multi_warehouse_management_service.MultiWarehouseManagementService._check_redistribution_needed")
    @patch(
        "services.multi_warehouse_management_service.MultiWarehouseManagementService._generate_distribution_recommendations"  # noqa: E501
    )
    def test_get_inventory_distribution(
        self, mock_recommendations, mock_needed, mock_optimal, mock_current, mock_total
    ):
...
class TestLogisticsIntegrationService(unittest.TestCase):
    ...
    @patch(
        "services.logistics_integration_service.LogisticsIntegrationService._generate_cost_optimization_recommendations"
    )
