...
class WindowManagerTester:
    ...
    def log_test(self, test_name: str, passed: bool, message: str = ""):
        ...
        status = "✅ PASSED" if passed else "❌ FAILED"  # noqa: F841
    ...
    def test_2_singleton_behavior(self):
        ...
        try:
            ...
            self.window_manager.register_window(window_key="test_singleton", window_class=TestWindow, singleton=True)
    ...
    def test_3_geometry_persistence(self):
        ...
        try:
            ...
            self.window_manager.register_window(window_key="test_geometry", window_class=TestWindow, singleton=True)
        ...
        try:
            ...
            for i in range(3):
                if self.window_manager.is_open(f"test_close_{i}"):
                    self.log_test("Test 3.2: close_all", False, f"النافذة test_close_{i} لم تُغلق")
                    return False
