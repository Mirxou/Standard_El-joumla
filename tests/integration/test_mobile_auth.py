...
from src.core.database_manager import DatabaseManager
from src.api.auth import JWTAuthManager
from src.api.routes import get_db_manager, get_auth_manager
from src.api.sync_routes import get_current_user
...
class TestMobileAuth:
    ...
    def auth_manager(self, mock_db_manager):
        ...
        with patch('src.core.security_service.AdvancedSecurityService.verify_password', return_value=True), \
    ...
    def client(self, mock_db_manager, auth_manager):
        ...
        with patch('src.api.app.ConfigManager') as MockConfigManager, \
             patch('src.api.app.DatabaseManager') as MockDatabaseManager, \
             patch('src.core.security_service.AdvancedSecurityService.verify_password', return_value=True), \
             patch('src.models.user.UserManager._verify_password', return_value=True):
    ...
    def test_login_failure(self, client):
        ...
        with patch.object(app.dependency_overrides[get_auth_manager](), 'authenticate_user', return_value=None):
            login_data = {
                "username": "testuser",
