...
from src.api.middleware import AuthMiddleware, LoggingMiddleware, RateLimitMiddleware
...
class TestAuthMiddleware:
    ...
    async def test_auth_middleware_valid_token(self, middleware, mock_request, auth_manager):
        ...
        response = await middleware.dispatch(mock_request, call_next)  # noqa: F841
