...
from src.ai.rpa_system import AutomationResult, AutomationScript, RPASystem, TaskType
...
class TestRPASystem:
    ...
    def test_record_script(self, rpa):
        ...
        script = rpa.record_script(script_id="recorded_001", name="Recorded Script", actions=actions)
