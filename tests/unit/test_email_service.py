...
class TestSendEmail:
    ...
    def test_send_email_with_port_465(self, mock_ssl, mock_smtp_ssl, service):
        ...
        result = service.send_email(to="to@example.com", subject="Test Subject", body_html="<p>Test</p>")
...
class TestSendInvoiceEmail:
    ...
    def test_send_invoice_email_success(self, mock_smtp_class, service):
        ...
        result = service.send_invoice_email(sale_id=1, to_email="john@example.com", include_pdf=True)
...
class TestSendAlert:
    ...
    def test_send_alert_success(self, mock_smtp_class, service):
        ...
        result = service.send_alert(to="alert@example.com", title="Test Alert", message="This is a test alert")
    ...
    def test_send_alert_creates_html(self, mock_smtp_class, service):
        ...
        result = service.send_alert(to="alert@example.com", title="Alert Title", message="Alert Message")  # noqa: F841
...
class TestSmtpLogin:
    ...
    def service(self):
        ...
        mock_print_service = Mock()
        config = {"smtp_user": "user@example.com", "smtp_password": "password123"}
        return EmailService(config=config, print_service=mock_print_service)
