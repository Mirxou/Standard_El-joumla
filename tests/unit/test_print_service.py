...
class TestPrintServiceInitialization:
    ...
    def test_initialization_without_db_manager(self):
        ...
        with patch('src.services.print_service.DatabaseManager') as mock_db_class, \
             patch('src.services.print_service.DatabaseConfigManager') as mock_db_config_class:
...
class TestPrintInvoice:
    ...
    def service_with_mocks(self):
        ...
        service._get_invoice_data = Mock(return_value={
...
class TestPrintQuote:
    ...
    def service_with_mocks(self):
        ...
        service._get_quote_data = Mock(return_value={
            'quote_number': 'QT-001',
            'customer_name': 'Test Customer'
        })
...
class TestBatchPrintInvoices:
    ...
    def service_with_mocks(self):
        ...
        service._get_invoice_data = Mock(side_effect=lambda sale_id: {
    ...
    def test_batch_print_success(self, service_with_mocks):
        ...
        result = service_with_mocks.batch_print_invoices(
            sale_ids=[1, 2, 3],
            template_name=None,
            save_pdf=True
        )
...
class TestGetInvoiceData:
    ...
    def test_get_invoice_data_success(self):
        ...
        service._get_company_info = Mock(return_value={
            'name': 'Test Company',
            'phone': '1234567890',
