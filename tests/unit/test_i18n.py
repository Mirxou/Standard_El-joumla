...
class TestI18n:
    ...
    def test_get_plural(self, i18n):
        ...
        singular = i18n.get_message("product", locale="ar") if i18n.has_locale("ar") else "product"
        plural = i18n.get_message("products", locale="ar") if i18n.has_locale("ar") else "products"
    ...
    def test_dynamic_messages(self, i18n):
        ...
        message = i18n.get_message("selling_price_lower_than_cost", 
                                   selling_price=100.0, 
                                   cost_price=150.0, 
                                   locale="ar")
