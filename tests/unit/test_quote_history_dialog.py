...
from PySide6.QtWidgets import QApplication, QDialog, QTableWidget, QPushButton, QDateEdit, QLineEdit
...
class TestQuoteHistoryDialog:
    ...
    def test_load_quotes(self, dialog):
        """اختبار تحميل العروض"""
        quotes = [
            {"id": 1, "quote_number": "Q001", "customer_name": "عميل 1", "total": Decimal("500.00"), "date": date(2024, 1, 15)},
            {"id": 2, "quote_number": "Q002", "customer_name": "عميل 2", "total": Decimal("750.00"), "date": date(2024, 1, 20)}
        ]
