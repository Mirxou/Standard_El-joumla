...
class Notification:
    def __init__(self, id=None, title="", message="", type=None, priority=None, 
                 category=None, user_id=None, action_url=None, data=None, 
                 read=False, read_at=None, created_at=None):
        self.id = id
        self.title = title
...
class MockNotificationService:
    ...
    def create_notification(self, title: str, message: str, 
                           ...
                           user_id=None, action_url=None, data=None) -> int:
        try:
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            """, (title, message, notification_type, priority.value, category.value, user_id, action_url, data_json))
    ...
    def get_notifications(self, user_id=None, unread_only=False, 
                         category=None, limit=50) -> List[Notification]:
        try:
            cursor = self.db.connection.cursor()
...
class TestGetNotifications:
    ...
    def service_with_mocks(self):
        ...
        mock_cursor.fetchall.return_value = [
            (1, "Title 1", "Message 1", "info", "high", "system", 1, None, None, 0, None, datetime.now().isoformat()),
            (2, "Title 2", "Message 2", "warning", "medium", "inventory", None, "/link", str({"key": "value"}), 1, datetime.now().isoformat(), datetime.now().isoformat())
        ]
        mock_db.connection.cursor.return_value = mock_cursor
...
class TestNotificationFiltering:
    ...
    def test_filter_by_priority(self):
        ...
        mock_cursor = Mock()
        mock_cursor.fetchall.return_value = [
            (1, "High Priority", "Message", "info", "high", "system", 1, None, None, 0, None, datetime.now().isoformat())
        ]
        mock_db.connection.cursor.return_value = mock_cursor
