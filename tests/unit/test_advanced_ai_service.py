...
from src.services.advanced_ai_service import AdvancedAIService, AIModel, TrainingData
...
class TestAdvancedAIService:
    ...
    def service(self, db_manager):
        with patch("src.services.advanced_ai_service.setup_logger", return_value=MagicMock()):
            with patch(
                "src.services.advanced_ai_service.CognitiveAIService",
                return_value=MagicMock(),
            ):
                with patch(
                    "src.services.advanced_ai_service.AdvancedAnalyticsService",
                    return_value=MagicMock(),
                ):
