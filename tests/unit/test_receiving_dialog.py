...
from PySide6.QtWidgets import QApplication, QDialog, QTableWidget, QLineEdit, QPushButton, QComboBox, QDateEdit
...
class TestReceivingDialog:
    ...
    def test_load_po_items(self, dialog):
        ...
        items = [
            {"product_id": 1, "product_name": "منتج 1", "ordered_qty": 100, "received_qty": 0},
            {"product_id": 2, "product_name": "منتج 2", "ordered_qty": 50, "received_qty": 0}
        ]
