...
class TestWebhookService:
    ...
    def test_get_all_webhooks_filter_by_event_type(self, webhook_service):
        ...
        sale_webhooks = webhook_service.get_all_webhooks(event_type="sale_created", company_id=1)
    ...
    def test_trigger_webhook(self, webhook_service):
        ...
        # إنشاء Webhook نشط
        webhook_id = webhook_service.create_webhook(  # noqa: F841
            name="Test Webhook",
            url="https://example.com/webhook",
            event_type="sale_created",
            is_active=True,
        ...
        webhook_service.trigger_webhook(event_type="sale_created", payload=payload, entity_id=123, company_id=1)
