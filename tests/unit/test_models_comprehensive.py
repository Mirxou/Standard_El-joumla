...
from src.models.payment import Payment, PaymentManager, PaymentType
...
class TestProductManagerCRUD:
    ...
    def test_get_product_by_barcode(self, product_manager, sample_product):
        ...
        product_id = product_manager.create_product(sample_product)  # noqa: F841
...
class TestProductCalculations:
    ...
    def test_profit_margin_calculation(self):
        ...
        product = Product(cost_price=100.0, selling_price=150.0)
    ...
    def test_stock_value_calculation(self):
        ...
        product = Product(cost_price=100.0, current_stock=50)
...
class TestSaleCalculations:
    ...
    def test_sale_calculate_totals(self):
        ...
        sale = Sale(discount_percentage=Decimal("10.00"), tax_percentage=Decimal("15.00"))

        # إضافة عناصر للفاتورة
        sale.items = [SaleItem(product_id=1, quantity=5, unit_price=Decimal("200.00"))]
...
class TestModelsEdgeCases:
    ...
    def test_product_with_zero_cost_price(self):
        ...
        product = Product(cost_price=0.0, selling_price=100.0)
    ...
    def test_payment_with_negative_amount(self):
        ...
        payment = Payment(amount=Decimal("-1000.00"), payment_type=PaymentType.REFUND.value)
