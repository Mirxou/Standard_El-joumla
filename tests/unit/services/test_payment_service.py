...
def test_create_supplier_payment(payment_service, db_manager):
    ...
    p = payment_service.create_supplier_payment(supplier_id=sid, amount=Decimal("500.00"), payment_method="cash")
    assert p is not None
...
def test_get_payment_by_id(payment_service, db_manager):
    ...
    db, cid = db_manager
    p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("200.00"))
    assert p is not None
...
def test_payment_with_reference_number(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("150"), reference_number=ref_num)
    assert p is not None
...
def test_payment_with_notes(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("75"), notes=notes)
    assert p is not None
...
def test_payment_validation_negative_amount(payment_service, db_manager):
    ...
    try:
        p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("-100"))
...
def test_payment_zero_amount(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("0"))
...
def test_payment_large_amount(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=large_amount)
    assert p is not None
...
def test_payment_decimal_precision(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=precise_amount)
    assert p is not None
...
def test_payment_with_custom_date(payment_service, db_manager):
    ...
    p = payment_service.create_customer_payment(customer_id=cid, amount=Decimal("100"), payment_date=custom_date)
    assert p is not None
