...
def test_imports():
    ...
    for module_path, class_name in modules_to_test:
        try:
            ...
            cls = getattr(module, class_name)  # noqa: F841
            # print(f"   ✅ {class_name}")
            tests_passed += 1
...
def test_database_initialization():
    ...
    try:
        ...
        db = DatabaseManager(":memory:")  # noqa: F841
...
def test_services_initialization():
    ...
    try:
        ...
        try:
            ...
            compliance = ComplianceService(db)  # noqa: F841
        ...
        try:
            ...
            monitor = SecurityMonitor(db, logger)  # noqa: F841
        ...
        try:
            ...
            logger = setup_logger(__name__)
            ids = IntrusionDetectionSystem(db, logger)  # noqa: F841
