...
from src.ui.websocket_client import WebSocketClient, WebSocketClientWorker, MessageType
...
class TestWebSocketClient:
    ...
    def test_websocket_client_handle_message_data_update(self, websocket_client):
        ...
        data_update_received_mock.emit.assert_called_once_with(
            "product", 123, "updated", {"name": "Test Product"}
        )
    ...
    def test_websocket_client_handle_message_notification(self, websocket_client):
        ...
        # التحقق من إرسال الإشارة
        notification_received_mock.emit.assert_called_once_with(
