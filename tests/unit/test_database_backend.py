...
class TestSQLiteBackend:
    ...
    def test_sqlite_backend_execute_query(self, sqlite_backend):
        ...
        # إدراج بيانات
        sqlite_backend.connection.execute("INSERT INTO test_table (name, value) VALUES (?, ?)", ("test", 123))
        sqlite_backend.connection.commit()
    ...
    def test_sqlite_backend_execute_insert(self, sqlite_backend):
        ...
        last_id = sqlite_backend.execute_insert("INSERT INTO test_table (name) VALUES (?)", ("test",))
    ...
    def test_sqlite_backend_execute_update(self, sqlite_backend):
        ...
        sqlite_backend.connection.execute("INSERT INTO test_table (id, name) VALUES (?, ?)", (1, "old_name"))
        sqlite_backend.connection.commit()

        rowcount = sqlite_backend.execute_update("UPDATE test_table SET name = ? WHERE id = ?", ("new_name", 1))
    ...
    def test_sqlite_backend_execute_update_no_match(self, sqlite_backend):
        ...
        rowcount = sqlite_backend.execute_update("UPDATE test_table SET name = ? WHERE id = ?", ("new_name", 999))
    ...
    def test_sqlite_backend_execute_delete(self, sqlite_backend):
        ...
        rowcount = sqlite_backend.execute_update("DELETE FROM test_table WHERE id = ?", (1,))
    ...
    def test_sqlite_backend_commit(self, sqlite_backend):
        ...
        sqlite_backend.begin_transaction()
        sqlite_backend.connection.execute("INSERT INTO test_table (id, name) VALUES (?, ?)", (1, "test"))
    ...
    def test_sqlite_backend_transaction_context_manager(self, sqlite_backend):
        ...
        try:
            with sqlite_backend.transaction():
                sqlite_backend.connection.execute("INSERT INTO test_table (id, name) VALUES (?, ?)", (2, "test2"))
