...
class TestUserAndUserManager:
    @pytest.fixture
    def user(self):
        return User(username="testuser", role=UserRole.ADMIN.value)
    ...
    def test_authenticate_user_success(self):
        ...
        # user row: id, username, email, full_name, phone, role, password_hash, salt, is_active, is_locked, failed_attempts...  # noqa: E501
        ...
        with patch.object(manager, "get_user_by_username") as mock_get_user, patch.object(
            manager, "_verify_password"
        ) as mock_verify:
    ...
    def test_get_all_users(self):
        ...
        # row: id, username, email, full_name, phone, role, password_hash, salt, is_active, is_locked, failed, last_login...  # noqa: E501
        # We need a minimal valid row.
        # Let's mock _row_to_user to make it easier
        with patch.object(manager, "_row_to_user") as mock_row_to_user, patch.object(
            manager, "_load_user_permissions"
        ) as mock_load_perms:
    ...
    def test_change_password(self):
        ...
        with patch.object(manager, "get_user_by_id") as mock_get, patch.object(
            manager, "_verify_password"
        ) as mock_verify:
