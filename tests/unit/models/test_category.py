...
class TestCategoryCreation(unittest.TestCase):
    ...
    def test_category_basic_creation(self):
        """إنشاء فئة أساسية"""
        category = Category(name="الملابس", description="فئة الملابس والأزياء")
...
class TestCategoryHierarchy(unittest.TestCase):
    ...
    def test_category_no_parent(self):
        """فئة بدون فئة أب"""
        category = Category(name="الملابس", parent_id=None)
        self.assertIsNone(category.parent_id)
        self.assertIsNone(category.parent_name)

    def test_category_with_parent_id(self):
        """فئة مع فئة أب"""
        category = Category(name="الملابس الرجالية", parent_id=1, parent_name="الملابس")
    ...
    def test_subcategory_hierarchy(self):
        ...
        child = Category(id=2, name="الملابس الرجالية", parent_id=parent.id, parent_name=parent.name)
...
class TestCategorySerialization(unittest.TestCase):
    ...
    def test_category_to_dict_with_timestamps(self):
        ...
        now = datetime.now()
        category = Category(id=1, name="الملابس", created_at=now, updated_at=now)
        category_dict = category.to_dict()
    ...
    def test_category_to_dict_with_parent(self):
        ...
        category = Category(id=2, name="الملابس الرجالية", parent_id=1, parent_name="الملابس")
        category_dict = category.to_dict()
    ...
    def test_category_to_dict_none_values(self):
        ...
        category = Category(name="الملابس", description=None, parent_id=None, created_at=None)
        category_dict = category.to_dict()
...
class TestCategoryProperties(unittest.TestCase):
    ...
    def test_category_description(self):
        ...
        category = Category(name="الملابس", description=desc)
...
class TestCategoryEdgeCases(unittest.TestCase):
    ...
    def test_category_zero_products(self):
        """فئة بدون منتجات"""
        category = Category(name="الملابس", products_count=0)
        self.assertEqual(category.products_count, 0)

    def test_category_large_products_count(self):
        """فئة بعدد كبير من المنتجات"""
        category = Category(name="الملابس", products_count=10000)
    ...
    def test_multiple_categories_hierarchy(self):
        ...
        grandchild = Category(
            id=3,
            name="الملابس الرجالية - قمصان",
            parent_id=2,
            parent_name="الملابس الرجالية",
        )
    ...
    def test_category_activation_toggle(self):
        ...
        category = Category(name="الملابس", is_active=True)
        self.assertTrue(category.is_active)
    ...
    def test_category_timestamps_update(self):
        ...
        now = datetime.now()
        category = Category(name="الملابس", created_at=now)
    ...
    def test_category_parent_id_large(self):
        ...
        category = Category(id=999999, name="فئة فرعية", parent_id=999998)
