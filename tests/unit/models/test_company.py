...
class TestCompanyCreation(unittest.TestCase):
    ...
    def test_company_with_dates(self):
        ...
        company = Company(name="Test Company", fiscal_year_start=start_date, fiscal_year_end=end_date)
    ...
    def test_company_is_default(self):
        ...
        company = Company(name="Default Company", is_default=True)

        self.assertTrue(company.is_default)

    def test_company_is_inactive(self):
        """اختبار شركة غير نشطة"""
        company = Company(name="Inactive Company", is_active=False)
...
class TestCompanyFinancial(unittest.TestCase):
    ...
    def test_company_tax_rate(self):
        """اختبار معدل الضريبة"""
        company = Company(name="Test Company", tax_rate=Decimal("21.00"))

        self.assertEqual(company.tax_rate, Decimal("21.00"))

    def test_company_with_currency(self):
        """اختبار الشركة مع العملة"""
        company = Company(name="Multi Currency Company", base_currency_id=1)
    ...
    def test_company_fiscal_year(self):
        ...
        company = Company(name="Test Company", fiscal_year_start=start, fiscal_year_end=end)
...
class TestCompanyMetadata(unittest.TestCase):
    ...
    def test_company_metadata(self):
        ...
        company = Company(name="Test Company", metadata='{"key": "value"}')

        self.assertEqual(company.metadata, '{"key": "value"}')

    def test_company_notes(self):
        """اختبار ملاحظات الشركة"""
        company = Company(name="Test Company", notes="هذه شركة تجريبية")

        self.assertEqual(company.notes, "هذه شركة تجريبية")

    def test_company_logo(self):
        """اختبار شعار الشركة"""
        company = Company(name="Test Company", logo_path="/path/to/logo.png")
...
class TestCompanyDateFormats(unittest.TestCase):
    ...
    def test_custom_date_format(self):
        ...
        company = Company(name="Test", date_format="DD/MM/YYYY", time_format="HH:mm")
...
class TestCompanyToDict(unittest.TestCase):
    ...
    def test_company_to_dict_basic(self):
        ...
        company = Company(id=1, code="ABC", name="Test Company", name_en="Test", tax_id="123456")
    ...
    def test_company_to_dict_with_dates(self):
        ...
        company = Company(id=1, name="Test", fiscal_year_start=start_date, created_at=created_at)
    ...
    def test_company_to_dict_boolean_conversion(self):
        ...
        company = Company(id=1, name="Test", is_active=True, is_default=False)
...
class TestCompanyFromDict(unittest.TestCase):
    ...
    def test_company_from_dict_boolean_conversion(self):
        ...
        data = {"id": 1, "name": "Test", "is_active": 1, "is_default": 0}
...
class TestUserCompanyCreation(unittest.TestCase):
    ...
    def test_user_company_creation_basic(self):
        ...
        user_company = UserCompany(id=1, user_id=1, company_id=1, role="admin")
    ...
    def test_user_company_is_default(self):
        ...
        user_company = UserCompany(user_id=1, company_id=1, is_default=True)

        self.assertTrue(user_company.is_default)

    def test_user_company_permissions(self):
        """اختبار الصلاحيات الخاصة"""
        user_company = UserCompany(user_id=1, company_id=1, permissions='{"read": true, "write": false}')
...
class TestUserCompanyToDict(unittest.TestCase):
    ...
    def test_user_company_to_dict_basic(self):
        ...
        user_company = UserCompany(id=1, user_id=1, company_id=1, role="manager")
    ...
    def test_user_company_to_dict_with_dates(self):
        ...
        user_company = UserCompany(id=1, user_id=1, company_id=1, created_at=created)
    ...
    def test_user_company_to_dict_boolean_conversion(self):
        ...
        user_company = UserCompany(id=1, user_id=1, company_id=1, is_default=True, is_active=False)
...
class TestCompanyEdgeCases(unittest.TestCase):
    ...
    def test_company_special_characters(self):
        ...
        company = Company(name="شركة ABC & XYZ", notes="ملاحظات مع رموز: !@#$%")
    ...
    def test_company_null_dates(self):
        ...
        company = Company(name="Test", fiscal_year_start=None, fiscal_year_end=None)
    ...
    def test_user_company_both_default_and_inactive(self):
        ...
        user_company = UserCompany(user_id=1, company_id=1, is_default=True, is_active=False)
    ...
    def test_company_to_dict_null_dates(self):
        ...
        company = Company(id=1, name="Test", fiscal_year_start=None, created_at=None)
