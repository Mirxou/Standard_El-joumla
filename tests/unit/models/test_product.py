...
class TestProductToDict(unittest.TestCase):
    ...
    def test_to_dict_decimal_to_float_conversion(self):
        ...
        product = Product(cost_price=Decimal("99.99"), selling_price=Decimal("149.95"))
        result = product.to_dict()
...
class TestProductEdgeCases(unittest.TestCase):
    ...
    def test_very_large_prices(self):
        """أسعار كبيرة جداً"""
        product = Product(cost_price=Decimal("999999999.99"), selling_price=Decimal("1000000000.00"))
    ...
    def test_unicode_names(self):
        ...
        product = Product(name="منتج عربي 123", name_en="English Product 123")
