...
class TestProductModel:
    ...
    def test_product_properties(self):
        product = Product(cost_price=100, selling_price=150, current_stock=10, min_stock=15)
    ...
    def test_product_to_dict(self):
        now = datetime.now()
        product = Product(id=1, name="Test", created_at=now, updated_at=now)
...
class TestProductManager:
    ...
    def test_row_to_product_variants(self, manager):
        ...
        row_long = row + (5, 99)  # 99 is dummy  # noqa: F841
