...
class TestQuoteItemCreation(unittest.TestCase):
    ...
    def test_quote_item_decimal_conversion(self):
        ...
        item = QuoteItem(quantity=5, unit_price=100)
...
class TestQuoteItemCalculations(unittest.TestCase):
    ...
    def test_quote_item_subtotal(self):
        ...
        item = QuoteItem(quantity=Decimal("5"), unit_price=Decimal("100.00"))
...
class TestQuoteValidity(unittest.TestCase):
    ...
    def test_quote_is_valid_future_date(self):
        ...
        quote = Quote(quote_number="QT001", valid_until=future_date)
    ...
    def test_quote_is_expired(self):
        ...
        quote = Quote(quote_number="QT001", valid_until=past_date)
...
class TestQuoteConversion(unittest.TestCase):
    ...
    def test_can_be_converted_accepted_status(self):
        ...
        future_date = date.today() + timedelta(days=30)
        quote = Quote(quote_number="QT001", status=QuoteStatus.ACCEPTED, valid_until=future_date)
    ...
    def test_cannot_convert_expired_quote(self):
        ...
        past_date = date.today() - timedelta(days=1)
        quote = Quote(quote_number="QT001", status=QuoteStatus.ACCEPTED, valid_until=past_date)
    ...
    def test_cannot_convert_draft_quote(self):
        ...
        future_date = date.today() + timedelta(days=30)
        quote = Quote(quote_number="QT001", status=QuoteStatus.DRAFT, valid_until=future_date)
...
class TestQuoteAddItem(unittest.TestCase):
    ...
    def test_add_multiple_items(self):
        ...
        for i in range(3):
            item = QuoteItem(product_id=i + 1, quantity=Decimal("5"), unit_price=Decimal("100"))
            quote.add_item(item)
...
class TestQuoteStatus(unittest.TestCase):
    ...
    def test_draft_quote(self):
        ...
        quote = Quote(quote_number="QT001", status=QuoteStatus.DRAFT)

        self.assertEqual(quote.status, QuoteStatus.DRAFT)

    def test_sent_quote(self):
        """اختبار عرض مرسول"""
        quote = Quote(quote_number="QT001", status=QuoteStatus.SENT, sent_date=date.today())
...
class TestQuoteNotes(unittest.TestCase):
    ...
    def test_quote_notes(self):
        ...
        quote = Quote(quote_number="QT001", notes="ملاحظات عامة للعميل")

        self.assertEqual(quote.notes, "ملاحظات عامة للعميل")

    def test_quote_internal_notes(self):
        """اختبار الملاحظات الداخلية"""
        quote = Quote(quote_number="QT001", internal_notes="ملاحظات داخلية لا يراها العميل")
...
class TestQuoteEdgeCases(unittest.TestCase):
    ...
    def test_quote_with_zero_total(self):
        ...
        quote = Quote(quote_number="QT001", total_amount=Decimal("0.00"))
    ...
    def test_quote_today_expiry(self):
        ...
        today = date.today()
        quote = Quote(quote_number="QT001", valid_until=today)
