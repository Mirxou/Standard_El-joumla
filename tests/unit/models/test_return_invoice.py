...
class TestReturnItemQuantities(unittest.TestCase):
    ...
    def test_return_item_quantities(self):
        """اختبار الكميات"""
        item = ReturnItem(quantity_returned=Decimal("5"), quantity_original=Decimal("10"))
...
class TestReturnItemPricing(unittest.TestCase):
    ...
    def test_return_item_unit_price(self):
        """اختبار سعر الوحدة"""
        item = ReturnItem(quantity_returned=Decimal("5"), unit_price=Decimal("100.00"))

        self.assertEqual(item.unit_price, Decimal("100.00"))

    def test_return_item_discount(self):
        """اختبار الخصم"""
        item = ReturnItem(unit_price=Decimal("100.00"), discount_amount=Decimal("50.00"))

        self.assertEqual(item.discount_amount, Decimal("50.00"))

    def test_return_item_tax(self):
        """اختبار الضريبة"""
        item = ReturnItem(unit_price=Decimal("100.00"), tax_amount=Decimal("15.00"))
...
class TestReturnItemReason(unittest.TestCase):
    ...
    def test_return_item_defective_reason(self):
        ...
        item = ReturnItem(product_id=1, return_reason=ReturnReason.DEFECTIVE)

        self.assertEqual(item.return_reason, ReturnReason.DEFECTIVE)

    def test_return_item_damaged_reason(self):
        """اختبار سبب الإرجاع: تالف"""
        item = ReturnItem(product_id=1, return_reason=ReturnReason.DAMAGED)
    ...
    def test_return_item_wrong_item_reason(self):
        ...
        item = ReturnItem(product_id=1, return_reason=ReturnReason.WRONG_ITEM)
    ...
    def test_return_item_expired_reason(self):
        ...
        item = ReturnItem(product_id=1, return_reason=ReturnReason.EXPIRED)
    ...
    def test_return_item_customer_request_reason(self):
        ...
        item = ReturnItem(product_id=1, return_reason=ReturnReason.CUSTOMER_REQUEST)
...
class TestReturnItemProductInfo(unittest.TestCase):
    ...
    def test_return_item_product_details(self):
        ...
        item = ReturnItem(product_id=1, product_name="منتج متقدم", product_barcode="123456789")
...
class TestReturnItemNotes(unittest.TestCase):
    ...
    def test_return_item_notes(self):
        ...
        item = ReturnItem(product_id=1, notes="ملاحظات خاصة عن المرتجع")
