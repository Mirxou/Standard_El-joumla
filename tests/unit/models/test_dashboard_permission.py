...
class TestDashboardData(unittest.TestCase):
    ...
    def test_dashboard_creation(self):
        """إنشاء لوحة معلومات"""
        today = date.today()
        dashboard = DashboardData(period_start=today, period_end=today)
...
class TestRole(unittest.TestCase):
    ...
    def test_role_can_perform(self):
        ...
        perm = Permission(resource_type=ResourceType.PRODUCTS, action=PermissionAction.VIEW)
...
class TestUser(unittest.TestCase):
    ...
    def test_user_creation(self):
        """إنشاء مستخدم"""
        user = User(id=1, username="ahmed", full_name="أحمد محمد", email="ahmed@example.com")
    ...
    def test_user_can_perform(self):
        ...
        perm = Permission(resource_type=ResourceType.PRODUCTS, action=PermissionAction.CREATE)
...
class TestLoginHistory(unittest.TestCase):
    ...
    def test_login_history_to_dict(self):
        ...
        history = LoginHistory(id=1, username="test", status="success", ip_address="127.0.0.1")
