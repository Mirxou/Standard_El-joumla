...
class TestPurchaseCreation(unittest.TestCase):
    ...
    def test_purchase_basic_creation(self):
        ...
        purchase = Purchase(invoice_number="INV001", supplier_id=1, supplier_name="المورد الأول")
...
def test_receive_purchase_items_updates_status_and_stock(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda product_id, quantity, unit_cost, expiry_date=None, batch_number=None: stock_updates.setdefault(
