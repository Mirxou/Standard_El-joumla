...
from src.services.report_generator import ReportGenerator, ReportType, ReportFilter
...
class TestReportGeneratorInitialization:
    ...
    def test_initialization_without_db_manager(self):
        ...
        with patch('src.services.report_generator.DatabaseManager') as mock_db_class, \
             patch('src.services.report_generator.ConfigManager') as mock_config_class:
