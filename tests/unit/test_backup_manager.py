...
from src.core.backup_manager import BackupConfig, BackupInfo, BackupManager
...
class TestBackupManager:
    ...
    def test_list_backups(self, backup_manager):
        ...
        result1 = backup_manager.create_backup()  # noqa: F841
        result2 = backup_manager.create_backup()  # noqa: F841
