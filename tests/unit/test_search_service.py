...
class TestSearchCriteria:
    ...
    def test_search_criteria_to_sql_contains(self):
        ...
        criteria = SearchCriteria(field="name", operator=SearchOperator.CONTAINS, value="test")
    ...
    def test_search_criteria_to_sql_equals(self):
        ...
        criteria = SearchCriteria(field="id", operator=SearchOperator.EQUALS, value=1)
    ...
    def test_search_criteria_to_sql_greater_than(self):
        ...
        criteria = SearchCriteria(field="price", operator=SearchOperator.GREATER_THAN, value=100)
...
class TestSearchProducts:
    ...
    def test_search_products_success(self, service_with_mocks):
        ...
        criteria_list = [SearchCriteria(field="name", operator=SearchOperator.CONTAINS, value="Product")]
    ...
    def test_search_products_empty_result(self, service_with_mocks):
        ...
        criteria_list = [SearchCriteria(field="name", operator=SearchOperator.CONTAINS, value="NonExistent")]
...
class TestSearchCustomers:
    ...
    def test_search_customers_by_name(self, service_with_mocks):
        ...
        criteria_list = [SearchCriteria(field="name", operator=SearchOperator.CONTAINS, value="John")]
    ...
    def test_search_customers_by_email(self, service_with_mocks):
        ...
        criteria_list = [SearchCriteria(field="email", operator=SearchOperator.CONTAINS, value="example.com")]
...
class TestGlobalSearch:
    ...
    def test_global_search_success(self):
        ...
        mock_db.execute_query.return_value = [{"id": 1, "name": "Test", "relevance": 1.0}]

        service = SearchService(db_manager=mock_db)

        # Mock full_text_search to return consistent results
        service.full_text_search = Mock(
            return_value=[
...
class TestBuildWhereClause:
    ...
    def test_build_where_clause_single_criteria(self):
        ...
        criteria_list = [SearchCriteria(field="name", operator=SearchOperator.CONTAINS, value="test")]
...
class TestSearchWithSorting:
    ...
    def test_search_with_sorting(self):
        ...
        result = service.search("products", criteria_list, sort_by="price", sort_order="DESC")
