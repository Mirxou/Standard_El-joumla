...
from src.ai.multi_agent_coordinator import AgentResult, AgentTask, MultiAgentCoordinator
...
class TestMultiAgentCoordinator:
    ...
    def test_create_task(self, coordinator):
        """اختبار إنشاء مهمة"""
        coordinator.register_agent("agent_001", {"name": "sales_analyzer", "capabilities": ["analysis"]})
    ...
    def test_get_task_status(self, coordinator):
        ...
        task = coordinator.create_task(task_type="analysis", parameters={}, assigned_agent="agent_001")
    ...
    def test_coordinate_agents(self, coordinator):
        ...
        coordinator.register_agent("agent_001", {"name": "analyzer", "capabilities": ["analysis"]})
        coordinator.register_agent("agent_002", {"name": "reporter", "capabilities": ["reporting"]})
    ...
    def test_find_agent_by_capability(self, coordinator):
        ...
        coordinator.register_agent("agent_001", {"name": "analyzer", "capabilities": ["sales_analysis"]})
        coordinator.register_agent("agent_002", {"name": "forecaster", "capabilities": ["forecasting"]})
    ...
    def test_task_queue_management(self, coordinator):
        ...
        # إضافة عدة مهام
        for i in range(3):
            coordinator.create_task(task_type=f"task_{i}", parameters={}, assigned_agent="agent_001")
