...
class TestSuperAdminDashboard:
    ...
    def window(self):
        ...
        with patch('src.ui.windows.super_admin_dashboard.SecurityMonitor'), \
             patch('src.ui.windows.super_admin_dashboard.IntrusionDetectionSystem'), \
             patch('src.ui.windows.super_admin_dashboard.WebhookService'), \
             patch('src.ui.windows.super_admin_dashboard.CloudSyncService'):
