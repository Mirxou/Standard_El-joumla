...
from src.ui.accessibility_utils import (
    AccessibilityUtils,
...
class TestAccessibilityUtils:
    ...
    def test_add_accessible_label(self):
        ...
        result = AccessibilityUtils.add_accessible_label(widget, "Test Widget", "This is a test widget")
    ...
    def test_create_accessible_button(self):
        ...
        button = AccessibilityUtils.create_accessible_button(
            "Click Me", "btn_submit", "Submit Button", min_size=(120, 50)
        )
    ...
    def test_create_accessible_label(self):
        ...
        label = AccessibilityUtils.create_accessible_label(
            "User Name", "lbl_username", "User Name Label", align=Qt.AlignCenter
        )
    ...
    def test_create_accessible_combo_without_items(self):
        ...
        combo = AccessibilityUtils.create_accessible_combo("cmb_empty", "Empty Combo", "Description")
...
class TestAccessibleFormBuilder:
    ...
    def test_add_input(self):
        ...
        result = builder.add_input("txt_name", "Name Input", "Enter your name", placeholder="John Doe")
    ...
    def test_add_combo(self):
        ...
        result = builder.add_combo("cmb_category", "Category", "Select category", ["A", "B", "C"])
    ...
    def test_add_checkbox(self):
        ...
        result = builder.add_checkbox("I agree to terms", "chk_terms", "Terms Checkbox")
    ...
    def test_add_button(self):
        ...
        result = builder.add_button("Submit", "btn_submit", "Submit Button")
    ...
    def test_chained_calls(self):
        ...
        result = (
            builder.add_label("Name:", "lbl_name", "Name Label")
