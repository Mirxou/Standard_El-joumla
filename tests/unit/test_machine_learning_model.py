...
from src.ai.machine_learning_model import SalesPredictionModel, InventoryOptimizationModel
...
class TestSaveLoadModel:
    ...
    def test_load_model(self):
        ...
        with patch('builtins.open', mock_open(read_data='{"weights": [1.0], "bias": 0.0, "is_trained": true}')):
