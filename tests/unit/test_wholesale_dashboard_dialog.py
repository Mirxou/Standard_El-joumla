...
from PySide6.QtWidgets import QApplication, QDialog, QTableWidget, QPushButton, QLabel, QComboBox, QDateEdit
...
class TestWholesaleDashboardDialog:
    ...
    def test_load_orders(self, dialog):
        ...
        orders = [
            {"id": 1, "order_number": "WO-001", "customer": "عميل جملة 1", "total": Decimal("5000.00")},
            {"id": 2, "order_number": "WO-002", "customer": "عميل جملة 2", "total": Decimal("7500.00")}
        ]
