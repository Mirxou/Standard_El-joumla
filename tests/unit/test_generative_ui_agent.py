...
from src.ai.generative_ui_agent import GenerativeUIAgent, UIComponent, GeneratedUI
...
class TestGenerativeUIAgent:
    ...
    def test_generate_code(self, agent):
        ...
        ui = GeneratedUI(
            ...
            title="Test Button",
            components=[
                UIComponent("comp_1", "button", {"text": "Click"}, {}, {})
            ],
            layout="horizontal",
            responsive=False,
            created_at=datetime.now()
    ...
    def test_validate_ui_design(self, agent):
        ...
        ui = GeneratedUI(
            ...
            title="Test Form",
            components=[
                UIComponent("comp_1", "input", {"label": "Name"}, {}, {})
            ],
            layout="vertical",
            responsive=True,
            created_at=datetime.now()
