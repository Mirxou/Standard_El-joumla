...
class MockDashboardService:
    ...
    def _kpi_avg_order_value(self, start, end) -> MockKPI:
        ...
        return MockKPI(key="aov", title="متوسط قيمة الطلب", value=aov, unit="ر.س", color="#3F51B5")
...
class TestKPICalculations:
    ...
    def test_kpi_sales(self, service_with_mocks):
        ...
        service, mock_db = service_with_mocks
        mock_db.execute_query.side_effect = [[{"value": 10000.0}], [{"value": 8000.0}]]
    ...
    def test_kpi_orders_count(self, service_with_mocks):
        ...
        service, mock_db = service_with_mocks
        mock_db.execute_query.side_effect = [[{"value": 100}], [{"value": 80}]]
    ...
    def test_kpi_cash_flow_positive(self, service_with_mocks):
        ...
        service, mock_db = service_with_mocks
        mock_db.execute_query.side_effect = [[{"value": 15000.0}], [{"value": 5000.0}]]
    ...
    def test_kpi_cash_flow_negative(self, service_with_mocks):
        ...
        service, mock_db = service_with_mocks
        mock_db.execute_query.side_effect = [[{"value": 5000.0}], [{"value": 15000.0}]]
