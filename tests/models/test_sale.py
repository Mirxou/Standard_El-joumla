...
from src.models.sale import SaleManager, Sale, SaleItem, SaleStatus, PaymentMethod
...
class TestSaleItems(unittest.TestCase):
    ...
    def test_sale_total_quantity(self):
        """إجمالي الكمية"""
        sale = Sale(invoice_number="INV001")
        item1 = SaleItem(product_id=1, product_name="منتج 1", quantity=5, unit_price=Decimal("100.00"))
        item2 = SaleItem(product_id=2, product_name="منتج 2", quantity=3, unit_price=Decimal("100.00"))
        sale.add_item(item1)
        sale.add_item(item2)
...
class TestSaleCalculations(unittest.TestCase):
    ...
    def test_sale_subtotal(self):
        ...
        sale = Sale(invoice_number="INV001")
        item1 = SaleItem(product_id=1, product_name="منتج 1", quantity=5, unit_price=Decimal("100.00"))
        item2 = SaleItem(product_id=2, product_name="منتج 2", quantity=3, unit_price=Decimal("200.00"))
        sale.add_item(item1)
        sale.add_item(item2)
...
class TestSaleEdgeCases(unittest.TestCase):
    ...
    def test_sale_multiple_payment_methods(self):
        ...
        for method in methods:
            sale = Sale(
                invoice_number=f"INV_{method.value}",
