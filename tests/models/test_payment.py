...
from src.models.payment import Payment, PaymentType, PaymentMethod, PaymentStatus, AccountType
...
class TestPaymentTypes(unittest.TestCase):
    ...
    def test_expense_payment(self):
        ...
        payment = Payment(
            ...
            payment_type=PaymentType.EXPENSE.value
        )
