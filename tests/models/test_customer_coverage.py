...
class TestCustomerCoverage:
    ...
    def test_create_customer_success(self, customer_manager, mock_db):
        ...
        mock_db.fetch_all.side_effect = [
            [(0, 'id'), (1, 'name'), (2, 'phone2')] # PRAGMA table_info result
        ]
    ...
    def test_get_customer_by_id_found(self, customer_manager, mock_db):
        ...
        mock_db.fetch_all.side_effect = [[(1, 'id'), (2, 'name')]] # for _get_available_columns inner call might happen or not depending on implementation, but let's mock fetch_one for the customer
    ...
    def test_get_customer_by_phone(self, customer_manager, mock_db):
        ...
        mock_db.fetch_all.return_value = [(0, 'id'), (1, 'name'), (2, 'phone'), (3, 'phone2')]
    ...
    def test_update_customer_success(self, customer_manager, mock_db):
        mock_db.fetch_all.return_value = [(0, 'id'), (1, 'name')] # PRAGMA for optional updates
    ...
    def test_tenant_manager_lazy_loading(self, customer_manager):
        ...
        tm = customer_manager.tenant_manager
