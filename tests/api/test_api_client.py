...
class TestAPIClient:
    ...
    @pytest.fixture
    def client(self):
        return APIClient(base_url="http://test-api.com", timeout=1, max_retries=1, retry_backoff_factor=0.0)
...
class TestHybridDataService:
    ...
    def test_get_products_offline(self, mock_db, mock_api):
        ...
        cursor.description = [("id",), ("name",), ("barcode",), ("unit",), ("selling_price",), ("current_stock",)]
