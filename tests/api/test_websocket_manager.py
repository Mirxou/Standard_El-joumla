...
from src.api.websocket_manager import WebSocketManager, MessageType, get_websocket_manager
...
class TestWebSocketManager:
    ...
    async def test_websocket_manager_disconnect(self, websocket_manager, mock_websocket):
        ...
        assert "test_room" not in websocket_manager.active_connections or \
               mock_websocket not in websocket_manager.active_connections.get("test_room", set())
        assert 123 not in websocket_manager.user_connections or \
               mock_websocket not in websocket_manager.user_connections.get(123, set())
    ...
    def test_websocket_manager_send_data_update(self, websocket_manager):
        ...
        try:
            async def setup_and_send():
                ...
                websocket_manager.send_data_update(
                    "data_updates",
                    "product",
                    123,
                    "updated",
